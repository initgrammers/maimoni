...
function Calendar({
  ...
  const disabledDate = disabled ? dayjs(disabled) : null;

  const canGoPrev =
    !disabledDate || currentMonth.isAfter(disabledDate, 'month');
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            ...
            disabled={!canGoPrev}
            className={cn(
              'h-11 w-11 rounded-2xl border border-slate-200 bg-white text-slate-500 transition hover:border-slate-300 hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-200',
